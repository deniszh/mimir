...
// Using a Deckhouse Prom++ fork of Prometheus with Mimir-specific changes.
replace github.com/prometheus/prometheus => github.com/deniszh/prompp v0.0.0-20250405165722-369359c083bc
